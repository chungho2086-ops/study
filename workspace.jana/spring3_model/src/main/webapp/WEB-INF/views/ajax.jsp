...
<button type="button" id="btn2">ajax2 실행</button>
<button type="button" id="btn3">ajax3 실행</button>
<button type="button" id="btn4">ajax4 실행</button>
<button type="button" id="btn5">ajax5 실행</button>
<button type="button" id="btn6">ajax6 실행</button>
